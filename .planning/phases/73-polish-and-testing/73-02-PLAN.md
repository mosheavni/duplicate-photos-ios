...
must_haves:
  ...
  artifacts:
    ...
    - path: "DuplicatePhotos/ViewModels/ScanViewModel.swift"
      provides: "Permission state tracking"
  ...
  key_links:
    ...
    - from: "DuplicatePhotos/ViewModels/ScanViewModel.swift"
      to: "DuplicatePhotos/Views/ContentView.swift"
      via: "permissionState published property"
      pattern: "viewModel\\.permissionState"
---
...
Note: Progress bar (SCAN-02) is already implemented in ScanProgressView - shows "X of Y" count and linear ProgressView. No additional work needed.
</objective>
...
<task type="auto">
  ...
  <files>DuplicatePhotos/Views/ContentView.swift, DuplicatePhotos/ViewModels/ScanViewModel.swift</files>
  <action>
